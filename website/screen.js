...
function populatePatients() {
	...
	execute("RELATION(select distinct p.subject_id, dob, sex, w.record_name from mimic2v26.d_patients p inner join patients_to_waveforms w on p.subject_id = w.subject_id where signal_id = 1 order by subject_id)", function(data) {
